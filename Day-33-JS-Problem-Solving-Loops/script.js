...
for (let i = 1; i < 6; i++) {
    let numb = +prompt("type any five numbers?");
    if (numb >= 0) {
        Counter++;
    }
}

console.log(`Total positive numbers count - ${Counter}`);
...
while(balance > 0 && withdrawalCount !== 3) {
    withdraw = +prompt("How much money do you want to withdraw?");
    withdrawalCount++;
